...
class Boy:
    ...
    def handle_collision(self, group, other):
        ...
        if group == 'boy:ball':
            self.ball_count += 1
            # game_world.remove_object(other) # 여기서 other은 ball인데 소년과 충돌해서 ball을 삭제할때, 여기서 한 번에 하는 것은 별로임
            # 객체지향 언어는 자신의 목숨은 자신이 결정하기에 이렇게 하면 ball 목숨을 소년이 갖고 있기 때문에 ball에서 삭제해야함.
